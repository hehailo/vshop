...
<template>
  <div class="detail">
    ...
    <section class="con">
      ...
      <div class="conPoin">
        <span
          v-show="categoryView.category1Name"
          :data-category1Id="categoryView.category1Id"
          >{{ categoryView.category1Name }}</span
        >
        <span
          v-show="categoryView.category2Name"
          :data-category2Id="categoryView.category2Id"
          >{{ categoryView.category2Name }}</span
        >
        <span
          v-show="categoryView.category3Name"
          :data-category3Id="categoryView.category3Id"
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getProdInfo", this.$route.params.skuid);
  },
  computed: {
    ...mapState({
      price: (state) => {
        return state.detail.productInfo.price;
      },
      valuesSkuJson: (state) => {
